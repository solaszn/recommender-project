...
importanceList = [(features, round(importance, 2)) for features, importance in zip(feature_list, important_features)]

from sklearn import metrics

accuracy = (metrics.accuracy_score(test_labels, predictions) * 100)
# print("FEATURE IMPORTANCE SCORE : ", importanceList)
alg_accuracy = round(accuracy)
...
def recommend(industry, service, rating):
    ...
    return predictSimilar(new_test)
...
# print("Running time: ", round(end_time - start_time), "seconds")

# 1st code
# ACCURACY : 16.6667%
# RUNNING TIME : 17 - 109 seconds

# 2nd fix - (Replace rating feature with product)
# ACCURACY : 11.0%
# RUNNING TIME : 17 seconds

# 3rd fix - (Add rating feature)
# ACCURACY : 15.0%
# RUNNING TIME : 25 seconds

# 4th fix - (Removed Market demographics feature)
# ACCURACY : 17.0%
# RUNNING TIME : 16 seconds

# 5th fix - (Delete Market demographics column from business dataset
# ACCURACY : 17.0%
# RUNNING TIME : 17 seconds
